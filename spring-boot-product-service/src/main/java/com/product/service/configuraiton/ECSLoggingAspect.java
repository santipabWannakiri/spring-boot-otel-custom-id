...
public class ECSLoggingAspect {
    ...
    @Before("execution(* com.product.service.serviceImpl.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.product.service.serviceImpl.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.product.service.serviceImpl.*.*(..))", throwing = "ex")
